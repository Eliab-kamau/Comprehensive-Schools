...
<fieldset>
<legend align="center">Enter Assessment Details And Save</legend>
<p>&nbsp;</p>
<p>&nbsp;</p>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center"  bgcolor="#00FF00">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">AssessmentCode:</td>
      <td><input type="text" name="AssessmentCode" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">AssessmentDescription:</td>
    ...
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">AssessmentDate:</td>
