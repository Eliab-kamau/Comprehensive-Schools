...
<fieldset>
<legend align="center">Enter Subject Grading Details And Save</legend>
<p align="center">&nbsp;</p>
<p align="center">&nbsp;</p>
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="center"  bgcolor="#00FF00">
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">SubGradeCode:</td>
      <td><input type="text" name="SubGradeCode" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">MinScore:</td>
      <td><input type="text" name="MinScore" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">MaxScore:</td>
      <td><input type="text" name="MaxScore" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
      <td nowrap="nowrap" align="right">RemarkCode:</td>
      <td><input type="text" name="RemarkCode" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
